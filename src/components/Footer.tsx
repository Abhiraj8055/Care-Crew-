    ...
    <footer className="bg-white border-t border-border mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4">CareCrew</h3>
            <p className="text-gray-600 text-sm">
              Connecting households with trusted domestic help in your neighborhood.
            </p>
          </div>
          
          <div>
            <h4 className="font-semibold mb-4">For Households</h4>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/join-as-provider" className="text-gray-600 hover:text-brand-600">
                  Join as Provider
                </Link>
              </li>
              <li>
                <Link to="/success-stories" className="text-gray-600 hover:text-brand-600">
                  Success Stories
                </Link>
              </li>
              <li>
                <Link to="/resources" className="text-gray-600 hover:text-brand-600">
                  Resources
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-200 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-600">
            &copy; {new Date().getFullYear()} CareCrew. All rights reserved.
          </p>
